...
class WeekView: UIView {
    ...
    private func configureSubviews() {
        var weekDays = self.config.calendar.veryShortWeekdaySymbols
       weekDays.append(weekDays.remove(at: 6))
...
extension FastisConfig {
    public struct WeekView {
        ...
        public var textColor: UIColor = UIColor.init(red: 57/255, green: 72/255, blue: 94/255, alpha: 0.54)
        public var textFont: UIFont = UIFont(name: "Poppins-Medium", size: 12.0) ?? .systemFont(ofSize: 12, weight: .bold)
